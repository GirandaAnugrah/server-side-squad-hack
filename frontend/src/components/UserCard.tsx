        ...
        <div className="flex gap-3">
          ...
          <div className="flex flex-col gap-1">
            <div className="flex justify-between">
              <h1 className="text-lg font-bold">Deviina Aryani</h1>
              <div className="px-2 py-1 text-sm text-primary-main border-[1px] border-primary-main">
                Part Time Math Tutor
              </div>
            </div>
            <p className="text-gray flex items-center text-color-text opacity-80 gap-1 flex-wrap">
              <span className="flex gap-1">
                <MapPin className="w-4 text-color-text" /> Tangerang -
              </span>
              <span className="flex">Rp. 500.000 - Rp. 1.500.000</span>
            </p>
            <p>
              Devina is autistic but has incredible knowledge in Mathematics and
              have 3 - 4 years of teaching experience as a Math Tutor for
              various Kindergarten
            </p>
            <div className="flex flex-wrap gap-2">
              <Chip className="bg-primary-main text-white-main">
                Mathematic
              </Chip>
              <Chip className="bg-primary-main text-white-main">
                Teach Experiance
