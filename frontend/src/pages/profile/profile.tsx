...
const ProfilePage = () => {
  return (
    <MainLayout>
    <div>
        <div className="mx-auto bg-white-main rounded-xl max-w-3xl shadow-sm p-6 pt-24 border-[1px] border-color-text border-opacity-5">
        <div className="flex align-middle gap-6">
          <img
            className="rounded-full w-36 h-36 border-[3px] border-primary-main border-opacity-25"
          ...
          <div>
            <div className="flex flex-col gap-2">
                <div className="grid grid-row-2 gap-2 mr-auto">
                ...
                <Chip className="bg-primary-main bg-opacity-15 text-primary-main">
                    Mathematic
                </Chip>
                <Chip className="bg-secondary-main bg-opacity-15 text-secondary-main">
                    Teach Experiance
                </Chip>
                <Chip className="bg-tertiary-main bg-opacity-15 text-tertiary-main">
                    Good With Children
                </Chip>
                </div>
            </div>
