      ...
      {!userData && (
        <div className="bg-darkgray-main py-24 px-16 text-white-main md:grid grid-cols-2 mt-32">
          <div className="flex flex-col gap-10 mr-8">
            ...
            <p>
              EqualPath is an application that collaborates with individuals
              with disabilities in finding suitable employment. This application
              aims to increase public awareness and perspective that people with
          ...
          <div className="flex flex-col gap-10">
            ...
            <p>
              ...
              connecting you with opportunities that align with your abilities
              and aspirations. Whether you’re an adept coder, a caretaker, or a
