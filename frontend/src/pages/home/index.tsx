    ...
    <MainLayout>
      ...
      <div className="xl:flex justify-between pt-20 mx-16">
        ...
        <OfferingCard 
          ...
          <OfferingCard 
            icon={<img src={IconKey} alt="" className="w-56 md:w-68" />}           title="Unlock Potential of your Skills"
            desc="By unlocking your potential, you’ll stand out to employers and open doors to exciting career prospects."/>
          <OfferingCard 
            icon={<img src={IconDisabled} alt="" className="w-56 md:w-68" />}            title=" Solution for the Disabled"
