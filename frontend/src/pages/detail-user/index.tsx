  ...
  return (
    <MainLayout>
      <div className="h-screen grid place-items-center">
        <div className="md:w-2/5 flex flex-col  mx-5">
          <div className="flex justify-between mb-2 flex-wrap">
            <img
              ...
              alt=""
              className="w-52 h-52 border-[2px] border-primary-main rounded-full mx-auto mb-2"
            />
            <div className="flex flex-col gap-3">
              <div className="font-semibold w-40 text-center px-2 py-1 text-sm text-primary-main border-[2px] border-primary-main">
                {userData?.email}
              </div>
              <h1 className="text-2xl font-bold">{userData?.fullName}</h1>
              <div className="flex flex-wrap gap-2">
                <Chip className="bg-primary-main">Cooking</Chip>
                <Chip className="bg-primary-main">House Assisting</Chip>
                <Chip className="bg-primary-main">Babysitting</Chip>
              </div>
            </div>
          </div>
          <p className="mb-5">
            I am autistic but possess incredible knowledge in Mathematics and
            have 3 - 4 years of teaching experience as a Math Tutor for various
            Kindergarten levels.
          </p>
          ...
          <div className="flex flex-col mt-5">
            ...
            <div className="flex gap-5">
              <h2>Street Name</h2>
              <h2>Jl. Patimura No. 2 Jakarta Timur </h2>
            </div>
          </div>
